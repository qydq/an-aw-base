...
import com.an.base.view.recyclerview.util.RecyclerViewStateUtils;
import com.an.base.view.recyclerview.view.LoadingFooter;
import com.qyddai.an_aw_base.R;
import com.qyddai.an_aw_base.model.adapter.SwipeMenuAdapter;
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //模拟一下网络请求失败的情况
                if (NetBroadcastReceiverUtils.isConnectedToInternet(SwipeDeleteActivity.this)) {
