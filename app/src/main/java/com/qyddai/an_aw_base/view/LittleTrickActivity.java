...
//如果添加注解，则夜间模式用不了，只能findViewById实现。LittleTrickActivity小动作activity
@ContentView(R.layout.sst_activity_littletrck)
public class LittleTrickActivity extends SuperActivity implements TaskDayNightContract.View {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            dialog.dismiss();
            Intent intent = new Intent(LittleTrickActivity.this, SlidingFinishActivity.class);
