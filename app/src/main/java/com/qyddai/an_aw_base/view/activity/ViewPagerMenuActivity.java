...
import com.qyddai.an_aw_base.model.adapter.MenuPagerAdapter;
import com.qyddai.an_aw_base.view.fragment.MenuFragment;
...
public class ViewPagerMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sst_activity_swipelayout_viewpager_menu);
