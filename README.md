...
* 项目的主要功能是作为[an框架](https://github.com/qydq/an)的基类（基础的an-base）的仓库；你可以借助jitpack ，bintrary快速集成。
...
+ an框架提供基本weight,YslidingDeleteListView,YshrinkScrollView、提供了recyclerview,refreshlayout,swipelayout系列。
