...
public class PickerSimpleView extends View {
    /**
    ...
    public PickerSimpleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.AnPickerView);
        loop = typedArray.getBoolean(R.styleable.AnPickerView_isLoop, loop);
        init();
    }
