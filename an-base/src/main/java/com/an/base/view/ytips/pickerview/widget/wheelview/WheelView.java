package com.an.base.view.ytips.pickerview.widget.wheelview;
...
import com.an.base.view.ytips.pickerview.adapter.WheelAdapter;
import com.an.base.view.ytips.pickerview.listener.OnItemSelectedListener;
import com.an.base.view.ytips.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.CommTxtPickerView_OutColor);
        textColorCenter = getResources().getColor(R.color.CommTxtPickerView_CenterColor);
        dividerColor = getResources().getColor(R.color.CommColorLinePickerView);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.CommDimenBarTitleMax);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PickerView_Library, 0, 0);
            mGravity = a.getInt(R.styleable.PickerView_Library_pickerview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.PickerView_Library_pickerview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.PickerView_Library_pickerview_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.PickerView_Library_pickerview_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.PickerView_Library_pickerview_textSize, textSize);
            a.recycle();
        }
