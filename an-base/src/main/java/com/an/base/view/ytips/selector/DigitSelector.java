package com.an.base.view.ytips.selector;
...
public class DigitSelector {
    ...
    private int startYear, endYear, minute_workStart, minute_workEnd, hour_workStart, hour_workEnd;
    ...
    public DigitSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        this.context = context;
        this.handler = resultHandler;
        startCalendar = Calendar.getInstance();
        endCalendar = Calendar.getInstance();
        startCalendar.setTime(DataService.INSTANCE.parse(startDate, FORMAT_STR));
        endCalendar.setTime(DataService.INSTANCE.parse(endDate, FORMAT_STR));
        initDialog();
        initView();
    }


    public DigitSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.base_selector_digit_selector);
    ...
    private void initView() {
        ...
        tvTips = (TextView) seletorDialog.findViewById(R.id.tvTips);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                java1.6 calender.getTime().getYear();方法过时。孙顺涛，qydq
...
//                int year = DataService.INSTANCE.format(selectedCalender.getTime();
                handler.handle(year);
                seletorDialog.dismiss();
            }
        });
