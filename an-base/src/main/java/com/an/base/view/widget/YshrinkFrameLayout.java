...
/*
* 可以缩放的布局FrameLayout
* qyddai@gamil.com shiluohua /qydq/ sunshuntao /qyddai
* */
public class YshrinkFrameLayout extends FrameLayout {
    // 屏幕宽高
    ...
    public YshrinkFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public YshrinkFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public YshrinkFrameLayout(Context context) {
        super(context);
        init(context);
    }
...
//            }
    ...
    public class ScaleGestureListener implements
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            // 缩放view
            if (scale > 0.5) {
                ViewHelper.setScaleX(YshrinkFrameLayout.this, scale);// x方向上缩放
                ViewHelper.setScaleY(YshrinkFrameLayout.this, scale);// y方向上缩放
            }
            return false;
        }
